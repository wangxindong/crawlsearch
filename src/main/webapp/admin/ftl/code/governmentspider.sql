...
Source Database       : governmentspider

Target Server Type    : MYSQL
Target Server Version : 50712
File Encoding         : 65001

Date: 2016-11-02 15:09:34
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for government_data
-- ----------------------------
DROP TABLE IF EXISTS `government_data`;
CREATE TABLE `government_data` (
  `id` varchar(255) NOT NULL COMMENT '编号',
  `oriurl` varchar(255) DEFAULT NULL COMMENT '种子url',
  `urladdress` varchar(255) DEFAULT NULL COMMENT '文章url',
  `title` varchar(255) DEFAULT NULL COMMENT '标题',
  `releasedate` varchar(255) DEFAULT NULL COMMENT '发布时间',
  `source` varchar(255) DEFAULT NULL COMMENT '来源',
  `keyword` varchar(255) DEFAULT NULL COMMENT '关键词',
  `subjectword` varchar(255) DEFAULT NULL COMMENT '主题词',
  `weight` varchar(255) DEFAULT NULL COMMENT '权重',
  `text` text COMMENT '正文',
  `labeltext` text COMMENT '带标签的正文',
  `sourcename` varchar(255) DEFAULT NULL COMMENT '附件名称',
  `sourceurl` varchar(255) DEFAULT NULL COMMENT '附件地址',
  `createtime` datetime DEFAULT NULL COMMENT '创建时间',
  `remarks` varchar(255) DEFAULT NULL COMMENT '备注',
  `reserve1` varchar(255) DEFAULT NULL COMMENT '预留1',
  `reserve2` varchar(255) DEFAULT NULL COMMENT '预留2',
  `reserve3` varchar(255) DEFAULT NULL COMMENT '预留3',
  `reserve4` varchar(255) DEFAULT NULL COMMENT '预留4',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='政府数据表';

-- ----------------------------
-- Records of government_data
-- ----------------------------
...
INSERT INTO `sys_menu` VALUES ('50', '站内信', 'fhsms/list.do', '6', '2', 'menu-icon fa fa-envelope green', '1', '0');
...
INSERT INTO `sys_role` VALUES ('3264c8e83d0248bb9e3ea6195b4c0216', '一级管理员', '33056569883686103670726', '1', '33056569883686103670726', '33056569883686103670726', '33056568757786196828102', '33056569883686103670726');
...
INSERT INTO `sys_role_fhbutton` VALUES ('4c65374b0a294101844513a6c7bd5b6b', '3264c8e83d0248bb9e3ea6195b4c0216', '3542adfbda73410c976e185ffe50ad06');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', 'de41b7fb99201d8334c23c014db35ecd92df81bc', '系统管理员', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2016-11-01 11:22:34', '0:0:0:0:0:0:0:1', '0', '最高统治者', 'default', 'QQ313596790@main.com', '001', '18788888888');
...
INSERT INTO `sys_user` VALUES ('ab341da0392b4ad280b938ca4871e31d', 'wxd', '5305a4d1ac21e06b55c9185090c666f9c3f407db', '王', '', '3264c8e83d0248bb9e3ea6195b4c0216', '2016-11-02 15:09:13', '0:0:0:0:0:0:0:1', '0', '55', 'default', '53@qq.com', '1103', '13000000000');
